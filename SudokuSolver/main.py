...
import time
from sudoku.solver import solve, valid, find_empty
from sudoku.json_functions import read_json
from sudoku.button_text import Button, WHITE, BLACK, RED, GREEN
...
GRAY = (128, 128, 128)
BOARD_DATA = read_json(join("sudoku", "board_data.json"))
